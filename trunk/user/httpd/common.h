...
#define EVM_RESTART_DNSFORWARDER	(1ULL << 47)
	...
	//#define EVM_RESTART_SS_TUNNEL	(1ULL << 48)
#define EVM_RESTART_MENTOHUST		(1ULL << 49)
	//#define EVM_RESTART_ADBYBY		(1ULL << 51)
#define EVM_RESTART_ALIDDNS		(1ULL << 50)
#define EVM_RESTART_FRP		    	(1ULL << 51)
#define EVM_RESTART_SMARTDNS		(1ULL << 52)
#define EVM_RESTART_ADGUARDHOME		(1ULL << 53)
#define EVM_RESTART_ZEROTIER		(1ULL << 54)
	//#define EVM_RESTART_DDNSTO		(1ULL << 60)
#define EVM_RESTART_ALDRIVER		(1ULL << 55)
#define EVM_RESTART_WIREGUARD		(1ULL << 56)
#define EVM_RESTART_SQM		   	(1ULL << 57)
#define EVM_RESTART_VNTCLI		(1ULL << 58)
