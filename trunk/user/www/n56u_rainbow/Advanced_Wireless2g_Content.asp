										...
										<div class="row-fluid">
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
														...
														<div class="controls">
															<label class="checkbox inline">
																<input type="checkbox" class="input"
																	name="rt_radio_date_x_Mon"
																	onChange="return changeDate();" />
																<#DAY_Mon#>
															</label>
															<label class="checkbox inline">
																<input type="checkbox" class="input"
																	name="rt_radio_date_x_Tue"
																	onChange="return changeDate();" />
																<#DAY_Tue#>
															</label>
															<label class="checkbox inline">
																<input type="checkbox" class="input"
																	name="rt_radio_date_x_Wed"
																	onChange="return changeDate();" />
																<#DAY_Wed#>
															</label>
															<label class="checkbox inline">
																<input type="checkbox" class="input"
																	name="rt_radio_date_x_Thu"
																	onChange="return changeDate();" />
																<#DAY_Thu#>
															</label>
															<label class="checkbox inline">
																<input type="checkbox" class="input"
																	name="rt_radio_date_x_Fri"
																	onChange="return changeDate();" />
																<#DAY_Fri#>
															</label>
														</div>
												...
												<tr>
													...
													<td>
														<div class="controls">
															<label class="checkbox inline">
																<input type="checkbox" class="input"
																	name="rt_radio_date_x_Sat"
																	onChange="return changeDate();" />
																<#DAY_Sat#>
															</label>
															<label class="checkbox inline">
																<input type="checkbox" class="input"
																	name="rt_radio_date_x_Sun"
																	onChange="return changeDate();" />
																<#DAY_Sun#>
															</label>
														</div>
												...
												<tr id="row_protect" style="display:none;">
													...
													<td>
														<select name="rt_gmode_protection" class="input"
															...
															<option value="auto" <% nvram_match_x( ""
																, "rt_gmode_protection" , "auto" , "selected" ); %>
																>Auto
															</option>
															<option value="on" <% nvram_match_x( ""
																, "rt_gmode_protection" , "on" , "selected" ); %>
																>Always On
															</option>
															<option value="off" <% nvram_match_x( ""
																, "rt_gmode_protection" , "off" , "selected" ); %>
																>Always Off
															</option>
														</select>
													</td>
												...
												<tr>
													...
													<td>
														<select name="rt_auth_mode" class="input"
															...
															<option value="psk" <% nvram_double_match_x( ""
																, "rt_auth_mode" , "psk" , "" , "rt_wpa_mode" , "1"
																, "selected" ); %>
																>WPA-Personal
															</option>
															<option value="psk" <% nvram_double_match_x( ""
																, "rt_auth_mode" , "psk" , "" , "rt_wpa_mode" , "2"
																, "selected" ); %>
																>WPA2-Personal (*)
															</option>
															<option value="psk" <% nvram_double_match_x( ""
																, "rt_auth_mode" , "psk" , "" , "rt_wpa_mode" , "0"
																, "selected" ); %>
																>WPA-Auto-Personal
															</option>
															<option value="wpa" <% nvram_double_match_x( ""
																, "rt_auth_mode" , "wpa" , "" , "rt_wpa_mode" , "3"
																, "selected" ); %>
															...
															<option value="wpa" <% nvram_double_match_x( ""
																, "rt_auth_mode" , "wpa" , "" , "rt_wpa_mode" , "4"
																, "selected" ); %>
												...
												<tr id="row_wpa1">
													...
													<td>
														<select name="rt_crypto" class="input"
															...
															<option value="aes" <% nvram_match_x( "" , "rt_crypto"
																, "aes" , "selected" ); %>
																>AES
															</option>
													...
													<td>
														<div class="input-append">
															...
															<button style="margin-left: -5px;" class="btn" type="button"
																onclick="passwordShowHide('rt_wpa_psk')">
												...
												<tr id="row_wep3">
													...
													<td>
														<input type="text" name="rt_key1" id="rt_key1" maxlength="32"
															class="input" size="34" value=""
															onKeyUp="return change_wlkey(this, 'WLANConfig11b');">
													</td>
												</tr>
												<tr id="row_wep4">
													<th>
													...
													<td>
														<input type="text" name="rt_key2" id="rt_key2" maxlength="32"
															class="input" size="34" value=""
															onKeyUp="return change_wlkey(this, 'WLANConfig11b');">
													</td>
												</tr>
												<tr id="row_wep5">
													...
													<td>
														<input type="text" name="rt_key3" id="rt_key3" maxlength="32"
															class="input" size="34" value=""
															onKeyUp="return change_wlkey(this, 'WLANConfig11b');">
													</td>
												</tr>
												<tr id="row_wep6">
													...
													<td>
														<input type="text" name="rt_key4" id="rt_key4" maxlength="32"
															class="input" size="34" value=""
															onKeyUp="return change_wlkey(this, 'WLANConfig11b');">
													</td>
												</tr>
