										...
										<div class="row-fluid">
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												...
												<tr id="row_dhcp_strict_order">
													...
													<td style="border-top: 0 none;">
														<input type="checkbox" id="dhcp_strict_order_fake" <% nvram_match_x("", "dhcp_strict_order" , "1"
															, "value=1 checked" ); %>
														<% nvram_match_x("", "dhcp_strict_order" , "0" , "value=0" ); %>>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="dhcp_strict_order" id="dhcp_strict_order_1" <%
												...
												<tr id="row_dhcp_proxy_dnssec">
													...
													<td style="border-top: 0 none;">
														<input type="checkbox" id="dhcp_proxy_dnssec_fake" <% nvram_match_x("", "dhcp_proxy_dnssec" , "1"
															, "value=1 checked" ); %>
														<% nvram_match_x("", "dhcp_proxy_dnssec" , "0" , "value=0" ); %>>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="dhcp_proxy_dnssec" id="dhcp_proxy_dnssec_1" <%
																	nvram_match_x("", "dhcp_proxy_dnssec" , "1" , "checked" ); %> /><#checkbox_Yes#>
																	<input type="radio" value="0" name="dhcp_proxy_dnssec" id="dhcp_proxy_dnssec_0" <%
																		nvram_match_x("", "dhcp_proxy_dnssec" , "0" , "checked" ); %> /><#checkbox_No#>
															</div>
													</td>
												</tr>
											</table>
