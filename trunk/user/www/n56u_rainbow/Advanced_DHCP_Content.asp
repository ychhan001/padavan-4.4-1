														...
														<% nvram_match_x( "" , "dhcp_enable_x" , "0" , "value=0" ); %>
															...
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="dhcp_enable_x"
																	id="dhcp_enable_x_1" <% nvram_match_x( ""
																	, "dhcp_enable_x" , "1" , "checked" ); %>
																>
																<#checkbox_Yes#>
																	<input type="radio" value="0" name="dhcp_enable_x"
																		id="dhcp_enable_x_0" <% nvram_match_x( ""
																		, "dhcp_enable_x" , "0" , "checked" ); %>
																	>
																	<#checkbox_No#>
															</div>
													</td>
												...
												<tr id="row_dhcpd_ap" style="display:none;">
													...
													<td style="border-top: 0 none;">
														<input type="checkbox" id="lan_dhcpd_x_fake" <%
															nvram_match_x( "" , "lan_dhcpd_x" , "1" , "value=1 checked"
															); %>
														<% nvram_match_x( "" , "lan_dhcpd_x" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="lan_dhcpd_x"
																	id="lan_dhcpd_x_1" <% nvram_match_x( ""
																	, "lan_dhcpd_x" , "1" , "checked" ); %>
																>
																<#checkbox_Yes#>
																	<input type="radio" value="0" name="lan_dhcpd_x"
																		id="lan_dhcpd_x_0" <% nvram_match_x( ""
																		, "lan_dhcpd_x" , "0" , "checked" ); %>
																	>
																	<#checkbox_No#>
															</div>
													</td>
												...
												<tr id="row_domain">
													...
													<td>
														<input type="text" maxlength="32" class="input" size="32"
															name="lan_domain" value="<% nvram_get_x(" ", "
															lan_domain "); %>">
													</td>
												</tr>
												<tr>
													...
													<td>
														<input type="text" maxlength="15" class="input" size="15"
															name="dhcp_start" value="<% nvram_get_x(" ", "
															dhcp_start "); %>"
												...
												<tr id="row_redirect_all_dns">
													...
													<td style="border-top: 0 none;">
														<input type="checkbox" id="redirect_all_dns_fake" <%
															...
															, "value=1 checked" ); %>
														<% nvram_match_x("", "redirect_all_dns" , "0" , "value=0" ); %>>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="redirect_all_dns"
																	...
																	<input type="radio" value="0"
																		name="redirect_all_dns" id="redirect_all_dns_0"
														...
														<% nvram_match_x("", "dhcp_filter_aaaa" , "0" , "value=0" ); %>>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="dhcp_filter_aaaa"
																	...
																	, "checked" ); %> /><#checkbox_Yes#>
																	<input type="radio" value="0"
																		name="dhcp_filter_aaaa" id="dhcp_filter_aaaa_0"
														...
														<% nvram_match_x("", "dhcp_all_servers" , "0" , "value=0" ); %>>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="dhcp_all_servers"
																	...
																	, "checked" ); %> /><#checkbox_Yes#>
																	<input type="radio" value="0"
																		name="dhcp_all_servers" id="dhcp_all_servers_0"
												...
												<tr id="row_dhcp_strict_order">
													...
													<td style="border-top: 0 none;">
														<input type="checkbox" id="dhcp_strict_order_fake" <%
															...
															, "value=1 checked" ); %>
														<% nvram_match_x("", "dhcp_strict_order" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
												...
												<tr id="row_dhcp_proxy_dnssec">
													...
													<td style="border-top: 0 none;">
														<input type="checkbox" id="dhcp_proxy_dnssec_fake" <%
															...
															, "value=1 checked" ); %>
														<% nvram_match_x("", "dhcp_proxy_dnssec" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
												...
												<tr>
													...
													<td>
														<select name="dhcp_verbose" class="input">
															<option value="0" <% nvram_match_x( "" , "dhcp_verbose"
																, "0" , "selected" ); %>
																>
																<#CTL_Disabled#> (*)
															</option>
															<option value="1" <% nvram_match_x( "" , "dhcp_verbose"
																, "1" , "selected" ); %>
																>DHCPv4
															</option>
															<option value="2" <% nvram_match_x( "" , "dhcp_verbose"
																, "2" , "selected" ); %>
																>DHCPv6
															</option>
															<option value="3" <% nvram_match_x( "" , "dhcp_verbose"
																, "3" , "selected" ); %>
																>DHCPv4 + DHCPv6
															</option>
														</select>
