												...
												<tr>
													...
													<td>
														<input type="checkbox" id="wins_enable_fake" <%
															nvram_match_x( "" , "wins_enable" , "1" , "value=1 checked"
															); %>
														<% nvram_match_x( "" , "wins_enable" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" name="wins_enable"
																	id="wins_enable_1" class="input" value="1"
												...
												<tr id="row_smb_lmb" style="display:none;">
													...
													<td>
														<select name="st_samba_lmb" class="input">
															<option value="0" <% nvram_match_x( "" , "st_samba_lmb"
																, "0" , "selected" ); %>
																>
																<#checkbox_No#>
															</option>
															<option value="1" <% nvram_match_x( "" , "st_samba_lmb"
																, "1" , "selected" ); %>
																>Local Master Browser (*)
															</option>
															<option value="2" <% nvram_match_x( "" , "st_samba_lmb"
																, "2" , "selected" ); %>
												...
												<tr id="div_ttyd">
													...
													<td colspan="2">
														<input type="checkbox" id="ttyd_enable_fake" <%
															nvram_match_x( "" , "ttyd_enable" , "1" , "value=1 checked"
															); %>
														<% nvram_match_x( "" , "ttyd_enable" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" name="ttyd_enable"
																	id="ttyd_enable_1" class="input" value="1"
												...
												<tr id="row_iperf3">
													...
													<td>
														<input type="checkbox" id="iperf3_enable_fake" <%
															nvram_match_x("", "iperf3_enable" , "1" , "value=1 checked"
															); %>
												...
												<tr>
													...
													<td>
														<input type="checkbox" id="lltd_enable_fake" <%
															nvram_match_x( "" , "lltd_enable" , "1" , "value=1 checked"
															); %>
														<% nvram_match_x( "" , "lltd_enable" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" name="lltd_enable"
																	id="lltd_enable_1" class="input" value="1" <%
												...
												<tr>
													...
													<td>
														<input type="checkbox" id="adsc_enable_fake" <%
															nvram_match_x( "" , "adsc_enable" , "1" , "value=1 checked"
															); %>
														<% nvram_match_x( "" , "adsc_enable" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" name="adsc_enable"
																	id="adsc_enable_1" class="input" value="1" <%
												...
												<tr>
													...
													<td>
														<input type="checkbox" id="crond_enable_fake" <%
															nvram_match_x( "" , "crond_enable" , "1" , "value=1 checked"
															); %>
														<% nvram_match_x( "" , "crond_enable" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" name="crond_enable"
																	id="crond_enable_1" class="input" value="1" <%
												...
												<tr>
													...
													<td>
														<input type="checkbox" id="watchdog_cpu_fake" <%
															nvram_match_x( "" , "watchdog_cpu" , "1" , "value=1 checked"
															); %>
														<% nvram_match_x( "" , "watchdog_cpu" , "0" , "value=0" ); %>
															>
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" name="watchdog_cpu"
																	id="watchdog_cpu_1" class="input" value="1" <%
