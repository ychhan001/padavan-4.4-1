...
<body onload="initial();" onunLoad="return unload_body();">
    <div class="wrapper">
        ...
        <form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
            ...
            <input type="hidden" name="dhcp_staticnum_x_0" value="<% nvram_get_x("", " dhcp_staticnum_x"); %>"
            readonly="1" />
                                ...
                                <div class="box well grad_colour_dark_blue">
                                    ...
                                    <div class="round_bottom">
                                        <div class="row-fluid">
                                            ...
                                            <div id="router_in_pool" class="alert alert-danger"
                                                style="display:none; margin: 10px;"><b>
                                                    <#LANHostConfig_DHCPServerConfigurable_sectiondesc2#> <span
                                                            id="LANIP"></span>
                                                </b></div>
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0"
                                                ...
                                                <tr id="row_dhcpd_rt">
                                                    <th style="border-top: 0 none;"><a class="help_tooltip"
                                                            ...
                                                            onmouseover="openTooltip(this, 5, 1);">
                                                            <#LANHostConfig_DHCPServerConfigurable_itemname#>
                                                        </a></th>
                                                    <td style="border-top: 0 none;">
                                                        <div class="main_itoggle">
                                                            <div id="dhcp_enable_x_on_of">
                                                                <input type="checkbox" id="dhcp_enable_x_fake" <%
                                                                    nvram_match_x("", "dhcp_enable_x" , "1"
                                                                    , "value=1 checked" ); %>
                                                        ...
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" name="dhcp_enable_x"
                                                                id="dhcp_enable_x_1" <%
                                                                nvram_match_x("","dhcp_enable_x", "1" , "checked" ); %>>
                                                            <#checkbox_Yes#>
                                                                <input type="radio" value="0" name="dhcp_enable_x"
                                                                    id="dhcp_enable_x_0" <%
                                                    ...
                                                    <td style="border-top: 0 none;">
                                                        <div class="main_itoggle">
                                                            <div id="lan_dhcpd_x_on_of">
                                                                <input type="checkbox" id="lan_dhcpd_x_fake" <%
                                                                    nvram_match_x("", "lan_dhcpd_x" , "1"
                                                                    , "value=1 checked" ); %>
                                                        ...
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" name="lan_dhcpd_x"
                                                                id="lan_dhcpd_x_1" <%
                                                                nvram_match_x("","lan_dhcpd_x", "1" , "checked" ); %>>
                                                            <#checkbox_Yes#>
                                                                <input type="radio" value="0" name="lan_dhcpd_x"
                                                                    id="lan_dhcpd_x_0" <%
                                                ...
                                                <tr id="row_domain">
                                                    <th><a class="help_tooltip" href="javascript:void(0);"
                                                            onmouseover="openTooltip(this,5,2);">
                                                            <#LANHostConfig_DomainName_itemname#>
                                                        </a></th>
                                                    <td>
                                                        <input type="text" maxlength="32" class="input" size="32"
                                                            name="lan_domain" value="<% nvram_get_x("", " lan_domain");
                                                            %>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="50%"><a class="help_tooltip" href="javascript:void(0);"
                                                            onmouseover="openTooltip(this,5,3);">
                                                            <#LANHostConfig_MinAddress_itemname#>
                                                        </a></th>
                                                    <td>
                                                        <input type="text" maxlength="15" class="input" size="15"
                                                            name="dhcp_start" value="<% nvram_get_x("", " dhcp_start");
                                                            %>" onKeyPress="return is_ipaddr(this,event);">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th><a class="help_tooltip" href="javascript:void(0);"
                                                            onmouseover="openTooltip(this,5,4);">
                                                            <#LANHostConfig_MaxAddress_itemname#>
                                                        </a></th>
                                                    <td>
                                                        <input type="text" maxlength="15" class="input" size="15"
                                                            name="dhcp_end" value="<% nvram_get_x(""," dhcp_end"); %>"
                                                        onKeyPress="return is_ipaddr(this,event);">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th><a class="help_tooltip" href="javascript:void(0);"
                                                            onmouseover="openTooltip(this,5,5);">
                                                            <#LANHostConfig_LeaseTime_itemname#>
                                                        </a></th>
                                                    <td>
                                                        <input type="text" maxlength="6" size="6" name="dhcp_lease"
                                                            class="input" value="<% nvram_get_x("", " dhcp_lease"); %>"
                                                ...
                                                <tr>
                                                    <th style="padding-bottom: 0px;"><a class="help_tooltip"
                                                            href="javascript:void(0);"
                                                            onmouseover="openTooltip(this,5,6);">
                                                            <#LANHostConfig_x_LGateway_itemname#>
                                                        </a></th>
                                                    <td style="padding-bottom: 0px;">
                                                        <input type="text" maxlength="15" class="input" size="15"
                                                            name="dhcp_gateway_x" value="<% nvram_get_x("", "
                                                            dhcp_gateway_x"); %>" onKeyPress="return
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0"
                                                ...
                                                <tr>
                                                    <th width="50%"><a class="help_tooltip" href="javascript:void(0);"
                                                            onmouseover="openTooltip(this,5,7);">
                                                            <#LANHostConfig_x_LDNSServer1_itemname#> 1:
                                                        </a></th>
                                                    <td>
                                                        <input type="text" maxlength="15" class="input" size="15"
                                                            name="dhcp_dns1_x" value="<% nvram_get_x("", "
                                                            dhcp_dns1_x"); %>" onKeyPress="return
                                                        is_ipaddr(this,event);" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th><a class="help_tooltip" href="javascript:void(0);"
                                                            onmouseover="openTooltip(this,5,8);">
                                                            <#LANHostConfig_x_LDNSServer1_itemname#> 2:
                                                        </a></th>
                                                    <td>
                                                        <input type="text" maxlength="15" class="input" size="15"
                                                            name="dhcp_dns2_x" value="<% nvram_get_x("", "
                                                            dhcp_dns2_x"); %>" onKeyPress="return
                                                        is_ipaddr(this,event);" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th><a class="help_tooltip" href="javascript:void(0);"
                                                            onmouseover="openTooltip(this,5,9);">
                                                            <#LANHostConfig_x_LDNSServer1_itemname#> 3:
                                                        </a></th>
                                                    <td>
                                                        <input type="text" maxlength="15" class="input" size="15"
                                                            name="dhcp_dns3_x" value="<% nvram_get_x("", "
                                                            dhcp_dns3_x"); %>" onKeyPress="return
                                                        is_ipaddr(this,event);" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th><a class="help_tooltip" href="javascript:void(0);"
                                                            ...
                                                            <#LANHostConfig_x_LDNSServer6_itemname#> :</th>
                                                    <td>
                                                        <input type="text" maxlength="40" class="input" size="15"
                                                            name="dhcp_dnsv6_x" value="<% nvram_get_x("", "
                                                            dhcp_dnsv6_x"); %>" onKeyPress="return
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-bottom: 0px;">
                                                        <input type="text" maxlength="15" class="input" size="15"
                                                            name="dhcp_wins_x" value="<% nvram_get_x("", "
                                                            dhcp_wins_x"); %>" onkeypress="return
                                                        is_ipaddr(this,event);" />
                                                    </td>
                                                </tr>
                                                        ...
                                                        <div class="main_itoggle">
                                                            <div id="redirect_all_dns_on_of">
                                                                <input type="checkbox" id="redirect_all_dns_fake" <%
                                                                    nvram_match_x("", "redirect_all_dns" , "1"
                                                                    , "value=1 checked" ); %>
                                                                <% nvram_match_x("", "redirect_all_dns" , "0"
                                                                    , "value=0" ); %>>
                                                            </div>
                                                        </div>
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" name="redirect_all_dns"
                                                                id="redirect_all_dns_1" <%
                                                                nvram_match_x("", "redirect_all_dns" , "1" , "checked"
                                                                ); %>><#checkbox_Yes#>
                                                                <input type="radio" value="0" name="redirect_all_dns"
                                                                    id="redirect_all_dns_0" <%
                                                                    nvram_match_x("", "redirect_all_dns" , "0"
                                                                    , "checked" ); %>><#checkbox_No#>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="main_itoggle">
                                                            <div id="dhcp_filter_aaaa_on_of">
                                                                <input type="checkbox" id="dhcp_filter_aaaa_fake" <%
                                                                    nvram_match_x("", "dhcp_filter_aaaa" , "1"
                                                                    , "value=1 checked" ); %>
                                                                <% nvram_match_x("", "dhcp_filter_aaaa" , "0"
                                                                    , "value=0" ); %>>
                                                            </div>
                                                        </div>
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" name="dhcp_filter_aaaa"
                                                                id="dhcp_filter_aaaa_1" <%
                                                                nvram_match_x("", "dhcp_filter_aaaa" , "1" , "checked"
                                                                ); %> /><#checkbox_Yes#>
                                                                <input type="radio" value="0" name="dhcp_filter_aaaa"
                                                                    id="dhcp_filter_aaaa_0" <%
                                                                    nvram_match_x("", "dhcp_filter_aaaa" , "0"
                                                                    , "checked" ); %> /><#checkbox_No#>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="main_itoggle">
                                                            <div id="dhcp_all_servers_on_of">
                                                                <input type="checkbox" id="dhcp_all_servers_fake" <%
                                                                    nvram_match_x("", "dhcp_all_servers" , "1"
                                                                    , "value=1 checked" ); %>
                                                                <% nvram_match_x("", "dhcp_all_servers" , "0"
                                                                    , "value=0" ); %>>
                                                            </div>
                                                        </div>
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" name="dhcp_all_servers"
                                                                id="dhcp_all_servers_1" <%
                                                                nvram_match_x("", "dhcp_all_servers" , "1" , "checked"
                                                                ); %> /><#checkbox_Yes#>
                                                                <input type="radio" value="0" name="dhcp_all_servers"
                                                                    id="dhcp_all_servers_0" <%
                                                                    nvram_match_x("", "dhcp_all_servers" , "0"
                                                                    , "checked" ); %> /><#checkbox_No#>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="main_itoggle">
                                                            <div id="dhcp_strict_order_on_of">
                                                                <input type="checkbox" id="dhcp_strict_order_fake" <%
                                                                    nvram_match_x("", "dhcp_strict_order" , "1"
                                                                    , "value=1 checked" ); %>
                                                                <% nvram_match_x("", "dhcp_strict_order" , "0"
                                                                    , "value=0" ); %>>
                                                            </div>
                                                        </div>
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" name="dhcp_strict_order"
                                                                id="dhcp_strict_order_1" <%
                                                                nvram_match_x("", "dhcp_strict_order" , "1" , "checked"
                                                                ); %> /><#checkbox_Yes#>
                                                                <input type="radio" value="0" name="dhcp_strict_order"
                                                                    id="dhcp_strict_order_0" <%
                                                                    nvram_match_x("", "dhcp_strict_order" , "0"
                                                                    , "checked" ); %> /><#checkbox_No#>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="main_itoggle">
                                                            <div id="dhcp_stop_dns_rebind_on_of">
                                                                <input type="checkbox" id="dhcp_stop_dns_rebind_fake" <%
                                                                    nvram_match_x("", "dhcp_stop_dns_rebind" , "1"
                                                                    , "value=1 checked" ); %>
                                                                <% nvram_match_x("", "dhcp_stop_dns_rebind" , "0"
                                                                    , "value=0" ); %>>
                                                            </div>
                                                        </div>
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" name="dhcp_stop_dns_rebind"
                                                                id="dhcp_stop_dns_rebind_1" <%
                                                                nvram_match_x("", "dhcp_stop_dns_rebind" , "1"
                                                                , "checked" ); %> /><#checkbox_Yes#>
                                                                <input type="radio" value="0"
                                                                    name="dhcp_stop_dns_rebind"
                                                                    id="dhcp_stop_dns_rebind_0" <%
                                                                    nvram_match_x("", "dhcp_stop_dns_rebind" , "0"
                                                                    , "checked" ); %> /><#checkbox_No#>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="main_itoggle">
                                                            <div id="dhcp_proxy_dnssec_on_of">
                                                                <input type="checkbox" id="dhcp_proxy_dnssec_fake" <%
                                                                    nvram_match_x("", "dhcp_proxy_dnssec" , "1"
                                                                    , "value=1 checked" ); %>
                                                                <% nvram_match_x("", "dhcp_proxy_dnssec" , "0"
                                                                    , "value=0" ); %>>
                                                            </div>
                                                        </div>
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" name="dhcp_proxy_dnssec"
                                                                id="dhcp_proxy_dnssec_1" <%
                                                                nvram_match_x("", "dhcp_proxy_dnssec" , "1" , "checked"
                                                                ); %> /><#checkbox_Yes#>
                                                                <input type="radio" value="0" name="dhcp_proxy_dnssec"
                                                                    id="dhcp_proxy_dnssec_0" <%
                                                                    nvram_match_x("", "dhcp_proxy_dnssec" , "0"
                                                                    , "checked" ); %> /><#checkbox_No#>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <select name="dhcp_verbose" class="input">
                                                            <option value="0" <% nvram_match_x("", "dhcp_verbose" , "0"
                                                                ,"selected"); %>><#CTL_Disabled#> (*)</option>
                                                            <option value="1" <% nvram_match_x("", "dhcp_verbose" , "1"
                                                                ,"selected"); %>>DHCPv4</option>
                                                            <option value="2" <% nvram_match_x("", "dhcp_verbose" , "2"
                                                                ,"selected"); %>>DHCPv6</option>
                                                            <option value="3" <% nvram_match_x("", "dhcp_verbose" , "3"
                                                                ,"selected"); %>>DHCPv4 + DHCPv6</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <a href="javascript:spoiler_toggle('spoiler_conf')"><span>
                                                                <#CustomConf#> "dnsmasq.conf"
                                                            </span></a>
                                                    ...
                                                    <td colspan="2">
                                                        ...
                                                        <div id="spoiler_dhcpconf" style="display:none;">
                                                            <textarea rows="16" wrap="off" spellcheck="false"
                                                                ...
                                                                style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("dnsmasq.dhcp.conf",""); %></textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr id="row_hosts">
                                                    <td colspan="2" style="padding-bottom: 0px;">
                                                        <a href="javascript:spoiler_toggle('spoiler_hosts')"><span>
                                                                <#CustomConf#> "hosts"
                                                            </span></a>
                                                        <div id="spoiler_hosts" style="display:none;">
                                                            <textarea rows="16" wrap="off" spellcheck="false"
                                                                maxlength="8192" class="span12" name="dnsmasq.hosts"
                                                                style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("dnsmasq.hosts",""); %></textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0"
                                                ...
                                                <tr>
                                                    <th colspan="2" width="50%"><a class="help_tooltip"
                                                            href="javascript:void(0);"
                                                            onmouseover="openTooltip(this,5,18);">
                                                            <#LANHostConfig_ManualDHCPEnable_itemname#>
                                                        </a></th>
                                                    <td colspan="2">
                                                        <div class="main_itoggle">
                                                            <div id="dhcp_static_x_on_of">
                                                                <input type="checkbox" id="dhcp_static_x_fake" <%
                                                                    nvram_match_x("", "dhcp_static_x" , "1"
                                                                    , "value=1 checked" ); %>
                                                        ...
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" name="dhcp_static_x"
                                                                id="dhcp_static_x_1"
                                                                onclick="change_dhcp_static_enabled()" <%
                                                                nvram_match_x("", "dhcp_static_x" , "1" , "checked" );
                                                                %> /><#checkbox_Yes#>
                                                                <input type="radio" value="0" name="dhcp_static_x"
                                                                    id="dhcp_static_x_0"
                                                                    onclick="change_dhcp_static_enabled()" <%
                                                                    nvram_match_x("", "dhcp_static_x" , "0" , "checked"
                                                                    ); %> /><#checkbox_No#>
                                                        </div>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="main_itoggle">
                                                            <div id="dhcp_static_arp_on_of">
                                                                <input type="checkbox" id="dhcp_static_arp_fake" <%
                                                                    nvram_match_x("", "dhcp_static_arp" , "1"
                                                                    , "value=1 checked" ); %>
                                                        ...
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" name="dhcp_static_arp"
                                                                ...
                                                                onclick="change_dhcp_static_enabled()" <%
                                                                nvram_match_x("", "dhcp_static_arp" , "1" , "checked" );
                                                                %> /><#checkbox_Yes#>
                                                                <input type="radio" value="0" name="dhcp_static_arp"
                                                                    id="dhcp_static_arp_0"
                                                                    onclick="change_dhcp_static_enabled()" <%
                                                                    nvram_match_x("", "dhcp_static_arp" , "0"
                                                                    , "checked" ); %> /><#checkbox_No#>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="row_static_header" style="display:none">
                                                    <td width="25%">
                                                        ...
                                                        <div class="input-append">
                                                            <input type="text" maxlength="12" class="span12" size="12"
                                                                name="dhcp_staticmac_x_0" value="<% nvram_get_x("", "
                                                                dhcp_staticmac_x_0"); %>" onkeypress="return
                                                    ...
                                                    <td width="25%">
                                                        <input type="text" maxlength="15" class="span12" size="15"
                                                            name="dhcp_staticip_x_0" value="<% nvram_get_x("", "
                                                            dhcp_staticip_x_0"); %>" onkeypress="return
                                                        is_ipaddr(this,event);"/>
                                                    </td>
                                                    <td width="45%">
                                                        <input type="text" maxlength="24" class="span12" size="20"
                                                            name="dhcp_staticname_x_0" value="<% nvram_get_x("", "
                                                            dhcp_staticname_x_0"); %>" onKeyPress="return
                                                        is_string(this,event);"/>
                                                    </td>
                                                    <td width="5%">
                                                ...
                                                <tr>
                                                    <td style="border: 0 none;">
                                                        <center><input name="button" type="button"
                                                                ...
                                                                onclick="applyRule();" value="<#CTL_apply#>" /></center>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
