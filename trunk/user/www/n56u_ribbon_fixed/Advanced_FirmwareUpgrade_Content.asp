                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="alert alert-info" style="margin: 10px;">
                                                <#FW_desc1#>
                                                    <ol>
                                                        ...
                                                        <li>
                                                            <#FW_desc7#><input id="bingtmp" class="btn btn-success" style="width:50px;display:none;" type="button"
                                                                    name="bingtmp" value="<#TMP_btn#>" onclick="submitInternet('bigtmp');" />
                                                        </li>
                                                    </ol>
                                            </div>
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="input" value="<% nvram_get_x("", "
                                                            productid"); %>" readonly="1"></td>
                                                </tr>
                                                <tr>
                                                    <th>
                                                        <#FW_item2#>
                                                    </th>
                                                    <td><input type="text" name="firmver" class="input"
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <center><input type="button" name="button"
                                                                class="btn btn-primary" style="width: 219px;"
                                                                onclick="fwUpload();" value="<#CTL_upload#>" /></center>
                                                    </td>
                                                </tr>
                                            </table>
