                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0"
                                                ...
                                                <tr>
                                                    <th width="50%" style="border-top: 0 none;"><a class="help_tooltip"
                                                            ...
                                                            onmouseover="openTooltip(this, 4, 1);">
                                                            <#LANHostConfig_IPRouters_itemname#>
                                                        </a></th>
                                                    <td style="border-top: 0 none;">
                                                        <input type="text" maxlength="15" class="input" size="15"
                                                            id="lan_ipaddr" name="lan_ipaddr" value="<% nvram_get_x("
                                                            LANHostConfig","lan_ipaddr"); %>" onKeyPress="return
                                                ...
                                                <tr>
                                                    <th><a class="help_tooltip" href="javascript:void(0);"
                                                            onmouseover="openTooltip(this, 4,2);">
                                                            <#LANHostConfig_SubnetMask_itemname#>
                                                        </a></th>
                                                    <td>
                                                        <input type="text" maxlength="15" class="input" size="15"
                                                            name="lan_netmask" value="<% nvram_get_x("
                                                            LANHostConfig","lan_netmask"); %>" onkeypress="return
                                                        is_ipaddr(this,event);" />
                                                ...
                                                <tr>
                                                    <th>
                                                        <a class="help_tooltip"  href="javascript:void(0);" onmouseover="openTooltip(this, 4,4);"><#LAN_STP_itemname#></a>
                                                    </th>
                                                    <td>
                                                        <div class="main_itoggle">
                                                            <div id="lan_stp_on_of">
                                                                <input type="checkbox" id="lan_stp_fake" <%
                                                                    nvram_match_x("", "lan_stp" , "1"
                                                                    , "value=1 checked" ); %>
                                                        ...
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" name="lan_stp" id="lan_stp_1"
                                                                <% nvram_match_x("", "lan_stp" , "1" , "checked" ); %>>
                                                            <#checkbox_Yes#>
                                                                <input type="radio" value="0" name="lan_stp"
                                                                    id="lan_stp_0" <% nvram_match_x("", "lan_stp" , "0"
                                                                    , "checked" ); %>><#checkbox_No#>
                                                        </div>
                                                    </td>
                                                </tr>
