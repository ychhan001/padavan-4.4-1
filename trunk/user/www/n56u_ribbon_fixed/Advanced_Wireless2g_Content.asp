                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0"
                                                    ...
                                                    <td style="border-top: 0 none;">
                                                        <div class="main_itoggle">
                                                            <div id="rt_radio_x_on_of">
                                                                <input type="checkbox" id="rt_radio_x_fake" <%
                                                                    nvram_match_x("","rt_radio_x", "1"
                                                                    , "value=1 checked" ); %>
                                                                <% nvram_match_x("","rt_radio_x", "0" , "value=0" ); %>>
                                                            </div>
                                                        </div>
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" id="rt_radio_x_1"
                                                                name="rt_radio_x" class="input" <%
                                                                nvram_match_x("","rt_radio_x", "1" , "checked" ); %>/>
                                                            <#checkbox_Yes#>
                                                                <input type="radio" value="0" id="rt_radio_x_0"
                                                                    name="rt_radio_x" class="input" <%
                                                    ...
                                                    <td>
                                                        <div class="controls">
                                                            <label class="checkbox inline"><input type="checkbox"
                                                                    class="input" name="rt_radio_date_x_Mon"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Mon#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox"
                                                                    class="input" name="rt_radio_date_x_Tue"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Tue#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox"
                                                                    class="input" name="rt_radio_date_x_Wed"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Wed#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox"
                                                                    class="input" name="rt_radio_date_x_Thu"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Thu#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox"
                                                                    class="input" name="rt_radio_date_x_Fri"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Fri#>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border-top: 0 none;">
                                                        <input type="text" maxlength="2" style="width: 20px;" size="2"
                                                            name="rt_radio_time_x_starthour"
                                                            onKeyPress="return is_number(this,event);" />:
                                                        <input type="text" maxlength="2" style="width: 20px;" size="2"
                                                            name="rt_radio_time_x_startmin"
                                                            onKeyPress="return is_number(this,event);" />&nbsp;-&nbsp;
                                                        <input type="text" maxlength="2" style="width: 20px;" size="2"
                                                            name="rt_radio_time_x_endhour"
                                                            onKeyPress="return is_number(this,event);" />:
                                                        <input type="text" maxlength="2" style="width: 20px;" size="2"
                                                            name="rt_radio_time_x_endmin"
                                                            onKeyPress="return is_number(this,event);" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="controls">
                                                            <label class="checkbox inline"><input type="checkbox"
                                                                    class="input" name="rt_radio_date_x_Sat"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Sat#>
                                                            </label>
                                                            <label class="checkbox inline"><input type="checkbox"
                                                                    class="input" name="rt_radio_date_x_Sun"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Sun#>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border-top: 0 none;">
                                                        <input type="text" maxlength="2" style="width: 20px;" size="2"
                                                            name="rt_radio_time2_x_starthour"
                                                            onKeyPress="return is_number(this,event);" />:
                                                        <input type="text" maxlength="2" style="width: 20px;" size="2"
                                                            name="rt_radio_time2_x_startmin"
                                                            onKeyPress="return is_number(this,event);" />&nbsp;-&nbsp;
                                                        <input type="text" maxlength="2" style="width: 20px;" size="2"
                                                            name="rt_radio_time2_x_endhour"
                                                            onKeyPress="return is_number(this,event);" />:
                                                        <input type="text" maxlength="2" style="width: 20px;" size="2"
                                                            name="rt_radio_time2_x_endmin"
                                                            onKeyPress="return is_number(this,event);" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="main_itoggle">
                                                            <div id="rt_closed_on_of">
                                                                <input type="checkbox" id="rt_closed_fake" <%
                                                                    nvram_match_x("", "rt_closed" , "1"
                                                                    , "value=1 checked" ); %>
                                                        ...
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" id="rt_closed_1"
                                                                name="rt_closed" <% nvram_match_x("", "rt_closed" , "1"
                                                                , "checked" ); %>><#checkbox_Yes#>
                                                                <input type="radio" value="0" id="rt_closed_0"
                                                                    name="rt_closed" <% nvram_match_x("", "rt_closed"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="rt_gmode" class="input"
                                                            onChange="return change_common_rt(this, 'WLANConfig11b', 'rt_gmode')">
                                                            <option value="6" <% nvram_match_x("","rt_gmode", "6"
                                                                ,"selected"); %>>b/g/n/ax Mixed</option>
                                                            <option value="2" <% nvram_match_x("","rt_gmode", "2"
                                                                ,"selected"); %>>b/g/n Mixed</option>
                                                            <option value="1" <% nvram_match_x("","rt_gmode", "1"
                                                                ,"selected"); %>>b/g Mixed</option>
                                                            <option value="5" <% nvram_match_x("","rt_gmode", "5"
                                                                ,"selected"); %>>g/n Mixed (*)</option>
                                                            <option value="3" <% nvram_match_x("","rt_gmode", "3"
                                                                ,"selected"); %>>n Only</option>
                                                            <option value="4" <% nvram_match_x("","rt_gmode", "4"
                                                                ,"selected"); %>>g Only</option>
                                                            <option value="0" <% nvram_match_x("","rt_gmode", "0"
                                                                ,"selected"); %>>b Only</option>
                                                        </select>
                                                ...
                                                <tr id="row_protect" style="display:none;">
                                                    <th><a class="help_tooltip" href="javascript:void(0);"
                                                            onmouseover="openTooltip(this, 0, 16);">
                                                            <#WLANConfig11b_BGProt11g_itemname#>
                                                        </a></th>
                                                    <td>
                                                        <select name="rt_gmode_protection" class="input"
                                                            onChange="return change_common_rt(this, 'WLANConfig11b', 'rt_gmode_protection')">
                                                            <option value="auto" <%
                                                                nvram_match_x("","rt_gmode_protection", "auto"
                                                                ,"selected"); %>>Auto</option>
                                                            <option value="on" <%
                                                                nvram_match_x("","rt_gmode_protection", "on"
                                                                ,"selected"); %>>Always On</option>
                                                            <option value="off" <%
                                                                nvram_match_x("","rt_gmode_protection", "off"
                                                                ,"selected"); %>>Always Off</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr id="row_HT_BW">
                                                    ...
                                                    <td>
                                                        <select name="rt_HT_BW" class="input"
                                                            onChange="return change_common_rt(this, 'WLANConfig11b', 'rt_HT_BW')">
                                                            <option value="0" <% nvram_match_x("","rt_HT_BW", "0"
                                                                ,"selected"); %>>20 MHz</option>
                                                            <option value="1" <% nvram_match_x("","rt_HT_BW", "1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="rt_channel" class="input"
                                                            onChange="return change_common_rt(this, 'WLANConfig11b', 'rt_channel')">
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr id="row_HT_EXTCHA">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="rt_mcs_mode" class="input">
                                                            <option value="0" <% nvram_match_x("", "rt_mcs_mode" , "0"
                                                                , "selected" ); %>><#checkbox_No#> (*)</option>
                                                            <option value="1" <% nvram_match_x("", "rt_mcs_mode" , "1"
                                                                , "selected" ); %>>HTMIX (1S) 45 Mbps</option>
                                                            <option value="2" <% nvram_match_x("", "rt_mcs_mode" , "2"
                                                                , "selected" ); %>>HTMIX (1S) 30 Mbps</option>
                                                            <option value="3" <% nvram_match_x("", "rt_mcs_mode" , "3"
                                                                , "selected" ); %>>HTMIX (1S) 15 Mbps</option>
                                                            <option value="4" <% nvram_match_x("", "rt_mcs_mode" , "4"
                                                                , "selected" ); %>>OFDM 12 Mbps</option>
                                                            <option value="5" <% nvram_match_x("", "rt_mcs_mode" , "5"
                                                                , "selected" ); %>>OFDM 9 Mbps</option>
                                                            <option value="6" <% nvram_match_x("", "rt_mcs_mode" , "6"
                                                                , "selected" ); %>>OFDM 6 Mbps</option>
                                                            <option value="7" <% nvram_match_x("", "rt_mcs_mode" , "7"
                                                                , "selected" ); %>>CCK 5.5 Mbps</option>
                                                            <option value="8" <% nvram_match_x("", "rt_mcs_mode" , "8"
                                                                , "selected" ); %>>CCK 2 Mbps</option>
                                                            <option value="9" <% nvram_match_x("", "rt_mcs_mode" , "9"
                                                                , "selected" ); %>>CCK 1 Mbps</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="rt_auth_mode" class="input"
                                                            onChange="return change_common_rt(this, 'WLANConfig11b', 'rt_auth_mode');">
                                                            <option value="open" <% nvram_match_x("", "rt_auth_mode"
                                                                , "open" , "selected" ); %>>Open System</option>
                                                            <option value="shared" <% nvram_match_x("", "rt_auth_mode"
                                                                , "shared" , "selected" ); %>>Shared Key</option>
                                                            <option value="psk" <%
                                                                nvram_double_match_x("", "rt_auth_mode" , "psk" , ""
                                                                , "rt_wpa_mode" , "1" , "selected" ); %>>WPA-Personal
                                                            </option>
                                                            <option value="psk" <%
                                                                nvram_double_match_x("", "rt_auth_mode" , "psk" , ""
                                                                , "rt_wpa_mode" , "2" , "selected" ); %>>WPA2-Personal
                                                                (*)</option>
                                                            <option value="psk" <%
                                                                nvram_double_match_x("", "rt_auth_mode" , "psk" , ""
                                                            ...
                                                            <option value="wpa" <%
                                                                nvram_double_match_x("", "rt_auth_mode" , "wpa" , ""
                                                                , "rt_wpa_mode" , "3" , "selected" ); %>>WPA-Enterprise
                                                                (Radius)</option>
                                                            <option value="wpa2" <% nvram_match_x("", "rt_auth_mode"
                                                            ...
                                                            <option value="radius" <% nvram_match_x("", "rt_auth_mode"
                                                ...
                                                <tr id="row_wpa1">
                                                    ...
                                                    <td>
                                                        <select name="rt_crypto" class="input"
                                                            onChange="return change_common_rt(this, 'WLANConfig11b', 'rt_crypto')">
                                                            <option value="aes" <% nvram_match_x("", "rt_crypto" , "aes"
                                                                , "selected" ); %>>AES</option>
                                                            <option value="tkip+aes" <% nvram_match_x("", "rt_crypto"
                                                ...
                                                <tr id="row_wep1">
                                                    ...
                                                    <td>
                                                        <select name="rt_wep_x" class="input"
                                                            onChange="return change_common_rt(this, 'WLANConfig11b', 'rt_wep_x');">
                                                            <option value="0" <% nvram_match_x("", "rt_wep_x" , "0"
                                                                , "selected" ); %>>None</option>
                                                            <option value="1" <% nvram_match_x("", "rt_wep_x" , "1"
                                                                , "selected" ); %>>WEP-64bits</option>
                                                            <option value="2" <% nvram_match_x("", "rt_wep_x" , "2"
                                                ...
                                                <tr id="row_wep2">
                                                    ...
                                                    <td>
                                                        <select name="rt_key" class="input"
                                                            onChange="return change_common_rt(this, 'WLANConfig11b', 'rt_key');">
                                                            <option value="1" <% nvram_match_x("","rt_key", "1"
                                                                ,"selected"); %>>1</option>
                                                            <option value="2" <% nvram_match_x("","rt_key", "2"
                                                                ,"selected"); %>>2</option>
                                                            <option value="3" <% nvram_match_x("","rt_key", "3"
                                                                ,"selected"); %>>3</option>
                                                            <option value="4" <% nvram_match_x("","rt_key", "4"
                                                                ,"selected"); %>>4</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr id="row_wep3">
                                                    ...
                                                    <td><input type="text" name="rt_key1" id="rt_key1" maxlength="32"
                                                            class="input" size="34" value=""
                                                            onKeyUp="return change_wlkey(this, 'WLANConfig11b');"></td>
                                                </tr>
                                                <tr id="row_wep4">
                                                    <th><a class="help_tooltip" href="javascript:void(0);"
                                                            onmouseover="openTooltip(this, 0, 18);">
                                                    ...
                                                    <td><input type="text" name="rt_key2" id="rt_key2" maxlength="32"
                                                            class="input" size="34" value=""
                                                            onKeyUp="return change_wlkey(this, 'WLANConfig11b');"></td>
                                                </tr>
                                                <tr id="row_wep5">
                                                    ...
                                                    <td><input type="text" name="rt_key3" id="rt_key3" maxlength="32"
                                                            class="input" size="34" value=""
                                                            onKeyUp="return change_wlkey(this, 'WLANConfig11b');"></td>
                                                </tr>
                                                <tr id="row_wep6">
                                                    ...
                                                    <td><input type="text" name="rt_key4" id="rt_key4" maxlength="32"
                                                            class="input" size="34" value=""
                                                            onKeyUp="return change_wlkey(this, 'WLANConfig11b');"></td>
                                                </tr>
                                                <tr id="row_wep7">
                                                    ...
                                                    <td>
                                                        <input type="text" name="rt_phrase_x" maxlength="64"
                                                            class="input" size="32" value=""
                                                            onKeyUp="return is_wlphrase('WLANConfig11b', 'rt_phrase_x', this);">
                                                    </td>
                                                </tr>
                                                <tr id="row_wpa3">
                                                    <th><a class="help_tooltip" href="javascript:void(0);"
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="7" size="7"
                                                            name="rt_wpa_gtk_rekey" class="input"
                                                            value="<% nvram_get_x("", " rt_wpa_gtk_rekey"); %>"
                                                        onKeyPress="return is_number(this,event);" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="3" size="3" name="rt_TxPower"
                                                            class="input" value="<% nvram_get_x("", " rt_TxPower"); %>"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="4" size="4"
                                                            name="rt_KickStaRssiLow" class="input"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="4" size="4"
                                                            name="rt_AssocReqRssiThres" class="input"
                                                            value="<% nvram_get_x("", " rt_AssocReqRssiThres"); %>" />
                                                        &nbsp;<span style="color:#888;">[-100..0]</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="rt_country_code" class="input"
                                                            onChange="return change_common_rt(this, 'WLANConfig11b', 'rt_country_code')">
                                                            <option value="US" <% nvram_match_x("", "rt_country_code"
                                                                , "US" ,"selected"); %>>USA (channels 1-11)</option>
                                                            <option value="TW" <% nvram_match_x("", "rt_country_code"
                                                                , "TW" ,"selected"); %>>Taiwan (channels 1-11)</option>
                                                            <option value="CN" <% nvram_match_x("", "rt_country_code"
                                                                , "CN" ,"selected"); %>>China (channels 1-13)</option>
                                                            <option value="JP" <% nvram_match_x("", "rt_country_code"
                                                                , "JP" ,"selected"); %>>Japan (channels 1-13)</option>
                                                            <option value="AU" <% nvram_match_x("", "rt_country_code"
                                                                , "AU" ,"selected"); %>>Australia (channels 1-13)
                                                            </option>
                                                            <option value="GB" <% nvram_match_x("", "rt_country_code"
                                                                , "GB" ,"selected"); %>>Europe (channels 1-13)</option>
                                                            <option value="RU" <% nvram_match_x("", "rt_country_code"
                                                                , "RU" ,"selected"); %>>Russia (channels 1-13)</option>
                                                            <option value="DB" <% nvram_match_x("", "rt_country_code"
                                            ...
                                            <table class="table">
                                                <tr>
                                                    <td id="col_goto5" width="50%"
                                                        style="margin-top: 10px; border-top: 0 none;">
                                                        <input type="button" class="btn btn-info" name="goto5"
                                                            value="<#GO_5G#>"
