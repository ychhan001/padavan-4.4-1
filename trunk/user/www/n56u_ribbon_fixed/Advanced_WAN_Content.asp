										...
										<div class="row-fluid">
													...
													<td>
														<select name="wan_pppoe_man" class="input"
															...
															<option value="1" <% nvram_match_x("", "wan_pppoe_man" , "1"
																, "selected" ); %>>DHCP or Static</option>
															<option value="2" <% nvram_match_x("", "wan_pppoe_man" , "2"
																, "selected" ); %>>ZeroConf (169.254.*.*)</option>
														</select>
													</td>
												</tr>
												<tr id="row_hwnat">
													...
													<td>
														<select name="hw_nat_mode" class="input">
															<option value="0" <% nvram_match_x("", "hw_nat_mode" , "0"
																, "selected" ); %>>Disable (Slow)</option>
															<option value="1" <% nvram_match_x("", "hw_nat_mode" , "1"
																, "selected" ); %>>Offload TCP/UDP for LAN/WLAN</option>
															<option value="2" <% nvram_match_x("", "hw_nat_mode" , "2"
																, "selected" ); %>>Offload TCP/UDP for LAN</option>
														</select>
													</td>
												</tr>
													...
													<td>
														<select name="sfe_enable" class="input">
															<option value="0" <% nvram_match_x("", "sfe_enable" , "0"
																, "selected" ); %>>Disable</option>
															<option value="1" <% nvram_match_x("", "sfe_enable" , "1"
																, "selected" ); %>>Enable for IPv4/IPv6</option>
															<option value="2" <% nvram_match_x("", "sfe_enable" , "2"
																, "selected" ); %>>Enable for IPv4/IPv6 and WiFi
															</option>
														</select>
													</td>
												</tr>
												<tr id="row_wan_poller">
													...
													<td>
														...
														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" name="gw_arp_ping" id="gw_arp_ping_1"
																value="1" <% nvram_match_x("", "gw_arp_ping" , "1"
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												...
												<tr id="row_dhcp_toggle">
													...
													<td>
														...
														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" name="x_DHCPClient" id="x_DHCPClient_1"
																class="input" value="1" onclick="set_wan_dhcp_auto(1);"
																<% nvram_match_x("", "x_DHCPClient" , "1" , "checked" );
																%>/><#checkbox_Yes#>
																<input type="radio" name="x_DHCPClient"
																	id="x_DHCPClient_0" class="input" value="0"
																	onclick="set_wan_dhcp_auto(0);" <%
																	nvram_match_x("", "x_DHCPClient" , "0" , "checked"
																	); %>/><#checkbox_No#>
														</div>
													</td>
												</tr>
												<tr id="row_wan_ipaddr">
													...
													<td><input type="text" name="wan_ipaddr" maxlength="15"
															class="input" size="15" value="<% nvram_get_x("","
															wan_ipaddr"); %>" onKeyPress="return
														is_ipaddr(this,event);"/></td>
												</tr>
												<tr id="row_wan_netmask">
													...
													<td><input type="text" name="wan_netmask" maxlength="15"
															class="input" size="15" value="<% nvram_get_x("","
															wan_netmask"); %>" onKeyPress="return
														is_ipaddr(this,event);"/></td>
												</tr>
												<tr id="row_wan_gateway">
													...
													<td><input type="text" name="wan_gateway" maxlength="15"
															class="input" size="15" value="<% nvram_get_x("","
															wan_gateway"); %>" onKeyPress="return
														is_ipaddr(this,event);"/></td>
												</tr>
												<tr id="row_wan_mtu">
													<th><#WAN_MTU#></th>
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
													...
													<td>
														...
														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" name="wan_dnsenable_x"
																...
																onclick="set_wan_dns_auto(1);" <%
																nvram_match_x("", "wan_dnsenable_x" , "1" , "checked" );
																%>/><#checkbox_Yes#>
																<input type="radio" name="wan_dnsenable_x"
												...
												<tr id="row_wan_dns1">
													<th width="50%"><a class="help_tooltip" href="javascript:void(0);"
															...
															<#IPConnection_x_DNSServer1_itemname#> 1:
														</a></th>
													<td>
														<input type="text" maxlength="15" class="input" size="15"
															name="wan_dns1_x" value="<% nvram_get_x(""," wan_dns1_x");
												...
												<tr id="row_wan_dns2">
													<th><a class="help_tooltip" href="javascript:void(0);"
															...
															<#IPConnection_x_DNSServer1_itemname#> 2:
														</a></th>
													<td>
														<input type="text" maxlength="15" class="input" size="15"
															name="wan_dns2_x" value="<% nvram_get_x(""," wan_dns2_x");
															%>" onkeypress="return is_ipaddr(this,event);"/>
													</td>
												</tr>
												<tr id="row_wan_dns3">
													<th><a class="help_tooltip" href="javascript:void(0);"
															...
															<#IPConnection_x_DNSServer1_itemname#> 3:
														</a></th>
													<td>
														<input type="text" maxlength="15" class="input" size="15"
															name="wan_dns3_x" value="<% nvram_get_x(""," wan_dns3_x");
															%>" onkeypress="return is_ipaddr(this,event);"/>
													</td>
												</tr>
											</table>
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
													...
													<td>
														<select name="wan_l2tpd" class="input">
															<option value="0" <% nvram_match_x("","wan_l2tpd", "0"
																,"selected"); %>>xL2TPD</option>
															<option value="1" <% nvram_match_x("","wan_l2tpd", "1"
																,"selected"); %>>RP-L2TP</option>
														</select>
													</td>
												</tr>
												<tr id="row_ppp_peer">
													...
													<td>
														<input type="text" name="wan_ppp_peer" class="input"
															...
															wan_ppp_peer"); %>" onKeyPress="return
													...
													<td style="border-top: 0 none;">
														...
														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" value="1" name="pppoemwan_enable"
																...
																nvram_match_x("", "pppoemwan_enable" , "1" , "checked"
																); %> /><#checkbox_Yes#>
																<input type="radio" value="0" name="pppoemwan_enable"
																	id="pppoemwan_enable_0" class="input"
														...
														<div class="main_itoggle">
															<div id="pppoesync_enable_on_of">
																<input type="checkbox" id="pppoesync_enable_fake" <%
																	...
																	, "value=1 checked" ); %>
																<% nvram_match_x("", "pppoesync_enable" , "0"
																	, "value=0" ); %> />
															</div>
														</div>
														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" value="1" name="pppoesync_enable"
																...
																nvram_match_x("", "pppoesync_enable" , "1" , "checked"
																); %> /><#checkbox_Yes#>
																<input type="radio" value="0" name="pppoesync_enable"
																	id="pppoesync_enable_0" class="input" value="0" <%
																	nvram_match_x("", "pppoesync_enable" , "0"
																	, "checked" ); %> /><#checkbox_No#>
														</div>
													</td>
												...
												<tr id="pppoemwan2">
													...
													<td>
														<input type="text" class="input" name="pppoe_num" id="pppoe_num"
															style="width: 200px" value="<% nvram_get_x(""," pppoe_num");
															%>" />
													</td>
												</tr>
												<tr id="pppoemwan1">
													...
													<td style="border-top: 0 none;">
														...
														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" value="1" name="pppoemwan_rules_x"
																...
																nvram_match_x("", "pppoemwan_rules_x" , "1" , "checked"
																); %> /><#checkbox_Yes#>
																<input type="radio" value="0" name="pppoemwan_rules_x"
												...
												<tr id="row_static_caption" style="display:none">
													<th width="25%">
														<#LANHostConfig_ManualMac_itemname#> <a
																href="javascript:sortbyMAC();" style="outline:0;"><i
																	class="icon-circle-arrow-down"></i></a>
													</th>
													<th width="25%">
														<#LANHostConfig_ManualIP_itemname#> <a
																href="javascript:sortbyIP();" style="outline:0;"><i
																	class="icon-circle-arrow-down"></i></a>
													</th>
													<th width="25%">
														<#LANHostConfig_ManualName_itemname#> <a
																href="javascript:sortbyName();" style="outline:0;"><i
																	class="icon-circle-arrow-down"></i></a>
													</th>
													<th width="20%">
														<#pppoemwan1_1#> <a href="javascript:sortbyName();"
																style="outline:0;"><i
																	class="icon-circle-arrow-down"></i></a>
													</th>
													<th width="5%">
														<center><a href="javascript:sortbyId();" style="outline:0;"><i
																	class="icon-th-list"></i></a></center>
													</th>
												</tr>
												<tr id="row_static_header" style="display:none">
													<td width="25%">
														...
														<div class="input-append">
															<input type="text" maxlength="12" class="span12" size="12"
																...
																pppoemwan_mac_x_0"); %>" onkeypress="return
															is_hwaddr(event);" style="float:left; width: 110px"/>
															<button class="btn btn-chevron" id="chevron" type="button"
																onclick="pullLANIPList(this);"
																title="Select the MAC of LAN clients."><i
													...
													<td width="25%">
														<input type="text" maxlength="15" class="span12" size="15"
															...
															pppoemwan_ip_x_0"); %>" onkeypress="return
														is_ipaddr(this,event);"/>
													</td>
													<td width="25%">
														<input type="text" maxlength="24" class="span12" size="20"
															name="pppoemwan_name_x_0" value="<% nvram_get_x("", "
															pppoemwan_name_x_0"); %>" onKeyPress="return
														is_string(this,event);"/>
													</td>
													<td width="20%">
														<input type="text" maxlength="24" class="span12" size="20"
															name="pppoemwan_interface_x_0" value="<% nvram_get_x("", "
															pppoemwan_interface_x_0"); %>" onKeyPress="return
														is_string(this,event);"/>
													</td>
													<td width="5%">
														<button class="btn" style="max-width: 219px" type="submit"
															onclick="return markGroupMDHCP(this, 64, ' Add ');"
															name="ManualDHCPList2" value="<#CTL_add#>" size="12"><i
												...
												<tr>
													...
													<td>
														<input type="text" maxlength="64" class="input" size="32"
															...
															wan_pppoe_username"); %>" onkeypress="return
														is_string(this,event);"/>
													</td>
												</tr>
												<tr>
													...
													<td>
														<div class="input-append">
															...
															<button style="margin-left: -5px;" class="btn" type="button"
																onclick="passwordShowHide('wan_pppoe_passwd')"><i
													...
													<td>
														<select name="wan_ppp_auth" class="input">
															...
															<option value="2" <% nvram_match_x("", "wan_ppp_auth" , "2"
																,"selected"); %>>CHAP</option>
															<option value="3" <% nvram_match_x("", "wan_ppp_auth" , "3"
																,"selected"); %>>MS-CHAPv2</option>
														</select>
													</td>
												</tr>
												<tr id="row_ppp_mppe">
												...
												<tr id="row_pppoe_mtu">
													...
													<td>
														<input type="text" maxlength="4" size="5" name="wan_pppoe_mtu"
															class="input" value="<% nvram_get_x("", " wan_pppoe_mtu");
															%>" onkeypress="return is_number(this,event);"/>
												...
												<tr id="row_pppoe_mru">
													...
													<td>
														<input type="text" maxlength="4" size="5" name="wan_pppoe_mru"
															class="input" value="<% nvram_get_x("", " wan_pppoe_mru");
															%>" onkeypress="return is_number(this,event);"/>
														&nbsp;<span style="color:#888;">[1000..1492]</span>
													</td>
												</tr>
												<tr id="row_pptp_mtu" style="display:none">
													...
													<td>
														<input type="text" maxlength="4" size="5" name="wan_pptp_mtu"
															class="input" value="<% nvram_get_x("", " wan_pptp_mtu");
															%>" onkeypress="return is_number(this,event);"/>
												...
												<tr id="row_pptp_mru" style="display:none">
													...
													<td>
														<input type="text" maxlength="4" size="5" name="wan_pptp_mru"
															class="input" value="<% nvram_get_x("", " wan_pptp_mru");
															%>" onkeypress="return is_number(this,event);"/>
												...
												<tr id="row_l2tp_mtu" style="display:none">
													...
													<td>
														<input type="text" maxlength="4" size="5" name="wan_l2tp_mtu"
															class="input" value="<% nvram_get_x("", " wan_l2tp_mtu");
															%>" onkeypress="return is_number(this,event);"/>
												...
												<tr id="row_l2tp_mru" style="display:none">
													...
													<td>
														<input type="text" maxlength="4" size="5" name="wan_l2tp_mru"
															class="input" value="<% nvram_get_x("", " wan_l2tp_mru");
															%>" onkeypress="return is_number(this,event);"/>
														&nbsp;<span style="color:#888;">[1000..1500]</span>
													</td>
												</tr>
												<tr>
													...
													<td>
														<label class="radio inline"><input type="radio" value="1"
																name="wan_ppp_lcp" class="input" <%
																nvram_match_x("", "wan_ppp_lcp" , "1" , "checked" ); %>>
															<#checkbox_Yes#></label>
														<label class="radio inline"><input type="radio" value="0"
																name="wan_ppp_lcp" class="input" <%
																nvram_match_x("", "wan_ppp_lcp" , "0" , "checked" ); %>>
															<#checkbox_No#></label>
													</td>
												</tr>
												<tr>
													...
													<td>
														<label class="radio inline"><input type="radio" value="1"
																name="wan_ppp_alcp" class="input" <%
																nvram_match_x("", "wan_ppp_alcp" , "1" , "checked" );
																%>><#checkbox_Yes#></label>
														<label class="radio inline"><input type="radio" value="0"
																name="wan_ppp_alcp" class="input" <%
																nvram_match_x("", "wan_ppp_alcp" , "0" , "checked" );
																%>><#checkbox_No#></label>
													</td>
												</tr>
												<tr id="row_pppoe_svc">
													...
													<td>
														<input type="text" maxlength="32" class="input" size="32"
															...
															wan_pppoe_service"); %>" onkeypress="return
														is_string(this,event);"/>
													</td>
												</tr>
												<tr id="row_pppoe_ac">
													...
													<td>
														<input type="text" maxlength="32" class="input" size="32"
															...
															wan_pppoe_ac"); %>" onkeypress="return
														is_string(this,event);"/>
													</td>
												</tr>
												<tr id="row_pppoe_it" style="display:none">
													...
													<td>
														<input type="text" maxlength="10" class="input" size="32"
															...
															wan_pppoe_idletime"); %>" onkeypress="return
												...
												<tr>
													...
													<td>
														...
														class="input" maxlength="255" size="32" onKeyPress="return
														is_string(this,event);"/>
													</td>
												</tr>
											</table>
											...
											<table width="100%" cellpadding="4" cellspacing="0" class="table">
												...
												<tr id="row_auth_host">
													...
													<td>
														<input type="text" name="wan_auth_host" class="input"
															...
															wan_auth_host"); %>" onKeyPress="return
														is_ipaddr(this,event);"/>
													</td>
												</tr>
												<tr id="row_auth_user">
													...
													<td>
														<input type="text" maxlength="64" class="input" size="32"
															...
															wan_auth_user"); %>" onKeyPress="return
														is_string(this,event);"/>
													</td>
												</tr>
												<tr id="row_auth_pass">
													...
													<td>
														<div class="input-append">
															<input type="password" maxlength="64" class="input"
																...
																style="width: 175px;" value="<% nvram_get_x("","
																wan_auth_pass"); %>" onKeyPress="return
															is_string(this,event);"/>
															<button style="margin-left: -5px;" class="btn" type="button"
																onclick="passwordShowHide('wan_auth_pass')"><i
																	class="icon-eye-close"></i></button>
														</div>
													</td>
												</tr>
												<tr id="row_hostname">
													...
													<td>
														<input type="text" name="wan_hostname" class="input"
															...
															wan_hostname"); %>" onkeypress="return
														is_string(this,event);"/>
													</td>
												</tr>
												<tr id="row_vci">
												...
												<tr>
													...
													<td>
														...
														<button type="button" class="btn" onclick="showMAC();"><i
																class="icon icon-plus"></i></button>
													</td>
												</tr>
												<tr>
													...
													<td>
														<select name="wan_ttl_value" class="input">
															<option value="0" <% nvram_match_x("", "wan_ttl_value" , "0"
																, "selected" ); %>><#WAN_TTL_Value_Item0#> (*)</option>
															<option value="64" <% nvram_match_x("", "wan_ttl_value"
																, "64" , "selected" ); %>><#WAN_TTL_Value_Item1#>
															</option>
															<option value="128" <% nvram_match_x("", "wan_ttl_value"
																, "128" , "selected" ); %>><#WAN_TTL_Value_Item2#>
															</option>
														</select>
													</td>
												</tr>
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												...
												<tr>
													...
													<td><input type="text" name="viptv_ipaddr" maxlength="15"
															class="input" size="15" value="<% nvram_get_x("","
															viptv_ipaddr"); %>" onKeyPress="return
														is_ipaddr(this,event);"/></td>
												</tr>
												<tr>
													<th>
													...
													<td><input type="text" name="viptv_netmask" maxlength="15"
															class="input" size="15" value="<% nvram_get_x("","
															viptv_netmask"); %>" onKeyPress="return
														is_ipaddr(this,event);"/></td>
												</tr>
												<tr>
													<th>
													...
													<td><input type="text" name="viptv_gateway" maxlength="15"
															class="input" size="15" value="<% nvram_get_x("","
															viptv_gateway"); %>" onKeyPress="return
														is_ipaddr(this,event);"/></td>
												</tr>
											</table>
											...
											<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<td>
														<select name="wan_stb_iso" class="input">
															...
															<option value="1" <% nvram_match_x("", "wan_stb_iso" , "1"
																, "selected" ); %>><#STB_IsolationItem1#>
															</option>
															<option value="2" <% nvram_match_x("", "wan_stb_iso" , "2"
																, "selected" ); %>><#STB_IsolationItem2#>
															</option>
														</select>
													</td>
												</tr>
												<tr>
													...
													<td>
														...
														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" name="vlan_filter" id="vlan_filter_1"
																value="1" onClick="change_stb_port_and_vlan();" <%
												...
												<tr id="vlan_inet">
													...
													<td>
														<span class="input-prepend"><span
																class="add-on">VID</span><input type="text"
																name="vlan_vid_cpu" class="wlan_filter" size="4"
																maxlength="4" value="<% nvram_get_x("", "
																vlan_vid_cpu"); %>" onkeypress="return
															is_number(this,event);"
															onblur="change_viptv_tag(1);"/>&nbsp;&nbsp;</span>
														<span class="input-prepend"><span
																class="add-on">PRIO</span><input type="text"
																name="vlan_pri_cpu" class="wlan_filter" size="2"
																maxlength="1" value="<% nvram_get_x("", "
																vlan_pri_cpu"); %>" onkeypress="return
															is_number(this,event);"/></span>
													</td>
												</tr>
												<tr id="vlan_iptv">
													<th>VLAN CPU (IPTV):</th>
													<td>
														<span class="input-prepend"><span
																class="add-on">VID</span><input type="text"
																name="vlan_vid_iptv" class="wlan_filter" size="4"
																maxlength="4" value="<% nvram_get_x("", "
																vlan_vid_iptv"); %>" onkeypress="return
															is_number(this,event);"
															onblur="change_viptv_tag(1);"/>&nbsp;&nbsp;</span>
														<span class="input-prepend"><span
																class="add-on">PRIO</span><input type="text"
																name="vlan_pri_iptv" class="wlan_filter" size="2"
																maxlength="1" value="<% nvram_get_x("", "
																vlan_pri_iptv"); %>" onkeypress="return
															is_number(this,event);"/></span>
												...
												<tr id="vlan_lan1">
													...
													<td>
														<span class="input-prepend"><span
																class="add-on">VID</span><input type="text"
																name="vlan_vid_lan1" class="wlan_filter" size="4"
																maxlength="4" value="<% nvram_get_x("", "
																vlan_vid_lan1"); %>" onkeypress="return
															is_number(this,event);"/>&nbsp;&nbsp;</span>
														<span class="input-prepend"><span
																class="add-on">PRIO</span><input type="text"
																name="vlan_pri_lan1" class="wlan_filter" size="2"
																maxlength="1" value="<% nvram_get_x("", "
																vlan_pri_lan1"); %>" onkeypress="return
															is_number(this,event);"/>&nbsp;&nbsp;</span>
														<label class="checkbox inline"><input type="checkbox"
																name="untag_lan1" value="" style="margin-left:10;"
																onclick="click_untag_lan(this,1);" <%
																nvram_match_x("", "vlan_tag_lan1" , "0" , "checked" );
																%>/><#UntagVLAN#></label>
													</td>
												</tr>
												<tr id="vlan_lan2">
													...
													<td>
														<span class="input-prepend"><span
																class="add-on">VID</span><input type="text"
																name="vlan_vid_lan2" class="wlan_filter" size="4"
																maxlength="4" value="<% nvram_get_x("", "
																vlan_vid_lan2"); %>" onkeypress="return
															is_number(this,event);"/>&nbsp;&nbsp;</span>
														<span class="input-prepend"><span
																class="add-on">PRIO</span><input type="text"
																name="vlan_pri_lan2" class="wlan_filter" size="2"
																maxlength="1" value="<% nvram_get_x("", "
																vlan_pri_lan2"); %>" onkeypress="return
															is_number(this,event);"/>&nbsp;&nbsp;</span>
														<label class="checkbox inline"><input type="checkbox"
																name="untag_lan2" value="" style="margin-left:10;"
																onclick="click_untag_lan(this,2);" <%
																nvram_match_x("", "vlan_tag_lan2" , "0" , "checked" );
																%>/><#UntagVLAN#></label>
													</td>
												</tr>
												<tr id="vlan_lan3">
													...
													<td>
														<span class="input-prepend"><span
																class="add-on">VID</span><input type="text"
																name="vlan_vid_lan3" class="wlan_filter" size="4"
																maxlength="4" value="<% nvram_get_x("", "
																vlan_vid_lan3"); %>" onkeypress="return
															is_number(this,event);"/>&nbsp;&nbsp;</span>
														<span class="input-prepend"><span
																class="add-on">PRIO</span><input type="text"
																name="vlan_pri_lan3" class="wlan_filter" size="2"
																maxlength="1" value="<% nvram_get_x("", "
																vlan_pri_lan3"); %>" onkeypress="return
															is_number(this,event);"/>&nbsp;&nbsp;</span>
														<label class="checkbox inline"><input type="checkbox"
																name="untag_lan3" value="" style="margin-left:10;"
																onclick="click_untag_lan(this,3);" <%
																nvram_match_x("", "vlan_tag_lan3" , "0" , "checked" );
																%>/><#UntagVLAN#></label>
													</td>
												</tr>
												<tr id="vlan_lan4">
													...
													<td>
														<span class="input-prepend"><span
																class="add-on">VID</span><input type="text"
																name="vlan_vid_lan4" class="wlan_filter" size="4"
																maxlength="4" value="<% nvram_get_x("", "
																vlan_vid_lan4"); %>" onkeypress="return
															is_number(this,event);"/>&nbsp;&nbsp;</span>
														<span class="input-prepend"><span
																class="add-on">PRIO</span><input type="text"
																name="vlan_pri_lan4" class="wlan_filter" size="2"
																maxlength="1" value="<% nvram_get_x("", "
																vlan_pri_lan4"); %>" onkeypress="return
															is_number(this,event);"/>&nbsp;&nbsp;</span>
														<label class="checkbox inline"><input type="checkbox"
																name="untag_lan4" value="" style="margin-left:10;"
																onclick="click_untag_lan(this,4);" <%
																nvram_match_x("", "vlan_tag_lan4" , "0" , "checked" );
																%>/><#UntagVLAN#></label>
													</td>
												</tr>
											</table>
