                                ...
                                <div class="box well grad_colour_dark_blue">
                                    ...
                                    <div class="round_bottom">
                                        <div class="row-fluid">
                                                ...
                                                <tr id="row_ether_jumbo">
                                                    ...
                                                    <td>
                                                        <select name="ether_jumbo" class="input">
                                                            <option value="0" <% nvram_match_x("","ether_jumbo", "0"
                                                                ,"selected"); %>>Up to 1536 bytes</option>
                                                            <option value="1" <% nvram_match_x("","ether_jumbo", "1"
                                                                ,"selected"); %>>Up to 16000 bytes</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        <div class="main_itoggle">
                                                            <div id="ether_green_on_of">
                                                                <input type="checkbox" id="ether_green_fake" <%
                                                                    nvram_match_x("", "ether_green" , "1"
                                                                    , "value=1 checked" ); %>
                                                        ...
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" value="1" name="ether_green"
                                                                id="ether_green_1" class="input" <%
                                                                nvram_match_x("", "ether_green" , "1" , "checked" ); %>
                                                            /><#checkbox_Yes#>
                                                                <input type="radio" value="0" name="ether_green"
                                                                    id="ether_green_0" class="input" <%
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table"
                                                id="tbl_ephy_l2" style="display:none;">
                                                <tr>
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table"
                                                id="tbl_ephy_l3" style="display:none;">
                                                <tr>
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table"
                                                id="tbl_ephy_l4" style="display:none;">
                                                <tr>
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table"
                                                id="tbl_ephy_l5" style="display:none;">
                                                <tr>
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table"
                                                id="tbl_ephy_l6" style="display:none;">
                                                <tr>
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table"
                                                id="tbl_ephy_l7" style="display:none;">
                                                <tr>
