...
{
#if defined (BOARD_N14U) || defined (BOARD_N11P) || defined (BOARD_MZ_R13) || defined (BOARD_MZ_R13P) || defined (BOARD_CR660x) || defined (BOARD_Q20) || defined (BOARD_RM2100) || defined (BOARD_RE_CP_02) || defined (BOARD_T6M)
	return 1;
#else
	return 0;
#endif
...
get_wired_mac_e2p_offset(int is_wan)
{
	...
	return 0xe006;	
#elif defined (BOARD_CR660x) || defined (BOARD_Q20) || defined (BOARD_RE_CP_02) || defined (BOARD_T6M)
	return 0x3FFFA;
#else
